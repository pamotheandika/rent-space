...
func (_m *Repository) AddSpace(ctx context.Context, space *spaces.Domain) error {
...
func (_m *Repository) GetAllSpace(ctx context.Context) ([]spaces.Domain, error) {
	ret := _m.Called(ctx)
...
func (_m *Repository) UpdateStatusSpace(ctx context.Context, IDSpace int) error {
