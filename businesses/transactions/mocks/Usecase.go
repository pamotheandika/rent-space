...
func (_m *Usecase) AddTransaction(ctx context.Context, transaction *transactions.Domain) error {
...
func (_m *Usecase) GetAllTransaction(ctx context.Context) ([]transactions.Domain, error) {
	ret := _m.Called(ctx)
...
func (_m *Usecase) UpdateStatusTransaction(ctc context.Context, IDTransaction int) error {
